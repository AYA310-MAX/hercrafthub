...
<div class="admin-wrapper">
  ...
  <main class="admin-main">
    <div class="admin-header">
      ...
      <span class="text-muted small">Welcome back, <?= $_SESSION['full_name'] ?> ✦</span>
    </div>
    ...
    <div class="row g-4 mb-4">
      <?php
        $stats = [
          ...
          ["Sellers",        $total_sellers,  "🛍️", "pink"],
          ["Buyers",         $total_buyers,   "🛒", "teal"],
          ["Total Listings", $total_listings, "📦", "amber"],
          ["Active Listings",$active_listings,"✅", "green"],
          ["Sold Items",     $sold_listings,  "🎉", "blue"],
        ];
        foreach($stats as $s):
      ?>
